...
const getById = "SELECT * FROM public.\"Partido\" WHERE \"ID\" = $1 ";
const checkIdExists = "SELECT \"Nombre_Torneo\" FROM public.\"Partido\" WHERE \"ID\" = $1";
const add = "INSERT INTO public.\"Partido\" ( \"ID\",\"Fecha\",\"Hora\",\"Nombre_Torneo\",\"Fase\",\"Equipo_1\",\"Equipo_2\",\"Sede\",\"Estado_del_partido\") VALUES ( $1 , $2 , $3 , $4 , $5 , $6 , $7 , $8 , $9 )";
