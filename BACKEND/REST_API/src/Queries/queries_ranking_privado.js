...
const add = "INSERT INTO public.\"Ranking_privado\" (\"Id_usuario\",\"id_comunidad\") VALUES ((select \"ID\" from public.\"Usuarios\ WHERE public.\"Usuarios\".\"Username\" = $1),(select \"ID\" from public.\"Comunidad_Privada\" where public.\"Comunidad_Privada\".\"Nombre\" = $2))";
