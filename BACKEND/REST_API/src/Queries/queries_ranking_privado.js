...
const getById = "SELECT CP.\"ID\" ,CP.\"Nombre\" 	FROM public.\"Ranking_privado\" AS RP	JOIN public.\"Comunidad_Privada\" AS CP ON CP.\"ID\" = RP.\"Id_comunidad\"	JOIN public.\"Usuarios\" AS U ON U.\"ID\" = RP.\"Id_usuario\"    WHERE U.\"Username\"= $1;";
