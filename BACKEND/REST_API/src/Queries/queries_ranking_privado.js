...
const add = "INSERT INTO public.\"Ranking_privado\" (\"Id_usuario\",\"id_Torneo\") VALUES ((select \"ID\" from public.\"Usuarios\ WHERE public.\"Usuarios\".\"Username\" = $1),(select \"ID\" from public.\"Torneo\" where public.\"Torneo\".\"Nombre\" = $2));";
