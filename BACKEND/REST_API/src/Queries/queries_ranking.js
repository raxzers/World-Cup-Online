const get = "select r.\"Id\",t.\"Nombre\",u.\"Username\",r.\"Puntaje\" from public.\"Ranking\"  r left join public.\"Torneo\" t on t.\"ID\"= r.\"id_Torneo\" left join public.\"Usuarios\" u on u.\"ID\"= r.\"id_Usuario\" order by ,r.\"Puntaje\" DESC";
