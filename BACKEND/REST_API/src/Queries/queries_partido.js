...
const getById = "SELECT * FROM public.\"Partido\" WHERE \"ID\" = $1  ORDER BY \"Fecha\",\"Hora\" DESC";
const getByTorneo = "SELECT * FROM public.\"Partido\" WHERE \"Nombre_Torneo\" = $1  ORDER BY \"Fecha\",\"Hora\" DESC";
